...
import { content } from "@/data/word-bank/starting-with-k";
...
export async function generateMetadata({
  ...
  return constructMetadata({
    page: "WordList",
    title: "5 Letter Words Starting With K — Wordle Word List & Hints",
    description: `All ${total} five-letter words starting with K, organized for Wordle. See the best K opening words like KNIFE and KAPUT, past answers, and definitions. Updated daily.`,
    keywords: [
