...
import { content } from "@/data/word-bank/starting-with-v";
...
export async function generateMetadata({
  ...
  return constructMetadata({
    page: "WordList",
    title: "5 Letter Words Starting With V — Wordle Word List & Hints",
    description: `All ${total} five-letter words starting with V, organized for Wordle. See the best V opening words like VOICE and VALUE, past answers, and definitions. Updated daily.`,
    keywords: [
