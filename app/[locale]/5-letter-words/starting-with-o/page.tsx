...
import { content } from "@/data/word-bank/starting-with-o";
...
export async function generateMetadata({
  ...
  return constructMetadata({
    page: "WordList",
    title: "5 Letter Words Starting With O — Wordle Word List & Hints",
    description: `All ${total} five-letter words starting with O, organized for Wordle. See the best O opening words like OCEAN and ORATE, past answers, and definitions. Updated daily.`,
    keywords: [
