...
import { content } from "@/data/word-bank/starting-with-x";
...
export async function generateMetadata({
  ...
  return constructMetadata({
    page: "WordList",
    title: "5 Letter Words Starting With X — Wordle Word List & Hints",
    description: `All ${total} five-letter words starting with X. A short reference list, with Wordle notes on why the daily answer never starts with X.`,
    keywords: [
      "5 letter words starting with x",
      "5 letter words that start with x",
      "5 letter words beginning with x",
