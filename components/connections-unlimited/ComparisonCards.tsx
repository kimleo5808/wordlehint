import { COMPARISON_ROWS } from "@/data/connections-unlimited/comparison";

/**
 * ComparisonCards — H2-5 side-by-side cards (connections edition).
 * Left card (Connections Unlimited) carries the signal-red accent edge.
 */
