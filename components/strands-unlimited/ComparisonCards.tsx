import { COMPARISON_ROWS } from "@/data/strands-unlimited/comparison";

/**
 * ComparisonCards — H2-5 side-by-side cards (strands edition).
 * Left card (Strands Unlimited) carries the signal-red accent edge.
 */
