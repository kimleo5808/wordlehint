import { RELATED_GAMES } from "@/data/wordle-unlimited/related-games";
import { Link as I18nLink } from "@/i18n/routing";

/**
 * RelatedGameGrid — H2-10 "Keep Playing" 4-card grid.
 *
 * Desktop: 4 columns. Mobile: 2 columns.
 * Each card has a mono small-caps category label, a Fraunces title, and a
 * one-line Newsreader description. Hover extends a signal-red underline.
 */
