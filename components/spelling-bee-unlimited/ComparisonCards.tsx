import { COMPARISON_ROWS } from "@/data/spelling-bee-unlimited/comparison";

/**
 * ComparisonCards — H2-5 side-by-side cards (spelling-bee edition).
 * Left card (Spelling Bee Unlimited) carries the signal-red accent edge.
 */
    ...
    <div className="my-6">
      ...
      <div className="space-y-4 sm:hidden">
        {COMPARISON_ROWS.map((row) => (
          <div key={row.dimension} className="border-l-2 border-brand-tan pl-3">
